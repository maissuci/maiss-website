...
export default function ContactPage() {
    return (
        ...
        <div className="container mx-auto px-4 py-12 max-w-5xl mt-20 relative">
            {/* Decorative background elements */}
            <div className="absolute top-20 left-10 w-96 h-96 rounded-full bg-gradient-to-r from-brand-pink/15 to-brand-lavender/10 blur-3xl -z-10"></div>
            <div className="absolute top-1/2 right-10 w-80 h-80 rounded-full bg-gradient-to-r from-brand-blue/15 to-brand-lavender/10 blur-3xl -z-10"></div>
            <div className="absolute bottom-20 left-1/3 w-72 h-72 rounded-full bg-gradient-to-r from-brand-pink/10 to-brand-blue/10 blur-3xl -z-10"></div>


            {/* Title */}
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-display font-semibold bg-gradient-to-r from-brand-pink via-brand-lavender to-brand-blue bg-clip-text text-transparent mb-4">
                    Got Questions?
                </h1>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-16 max-w-3xl mx-auto">
                ...
                {/* Instagram Card */}
                <Card className="border border-mist shadow-soft hover:shadow-md transition-shadow">
                    <CardHeader className="flex flex-row items-center gap-4 pb-2">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-brand-pink to-brand-lavender text-white">
                            <Instagram className="w-5 h-5" />
                        </div>
                        <h3 className="text-xl font-semibold">Instagram</h3>
                    </CardHeader>
                    <CardContent className="pt-2">
                        <p className="text-muted">Follow us on Instagram for live updates.</p>
                    </CardContent>
                    <CardFooter>
                        <Button
                            variant="ghost"
                            className="gap-2 text-brand-lavender hover:text-brand-pink hover:bg-mist pl-0"
                            asChild
                        >
                ...
                <Card className="border border-mist shadow-soft hover:shadow-md transition-shadow">
                    <CardHeader className="flex flex-row items-center gap-4 pb-2">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-brand-lavender to-brand-blue text-white">
                            <Mail className="w-5 h-5" />
                        </div>
                        <h3 className="text-xl font-semibold">Email</h3>
                    </CardHeader>
                    <CardContent className="pt-2">
                        <p className="text-muted">Reach out to us directly via email.</p>
                    </CardContent>
                    <CardFooter>
                        <Button
                            variant="ghost"
                            className="gap-2 text-brand-lavender hover:text-brand-blue hover:bg-mist pl-0"
                            asChild
                        >
                ...
                <Card className="border border-mist shadow-soft hover:shadow-md transition-shadow">
                    <CardHeader className="flex flex-row items-center gap-4 pb-2">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-brand-blue to-brand-lavender text-white">
                            <Linkedin className="w-5 h-5" />
                        </div>
                        <h3 className="text-xl font-semibold">LinkedIn</h3>
                    </CardHeader>
                    <CardContent className="pt-2">
                        <p className="text-muted">Connect with us professionally on LinkedIn.</p>
                    </CardContent>
                    <CardFooter>
                        <Button
                            variant="ghost"
                ...
                <Card className="border border-mist shadow-soft hover:shadow-md transition-shadow">
                    <CardHeader className="flex flex-row items-center gap-4 pb-2">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-brand-lavender to-brand-pink text-white">
                            <Discord className="w-5 h-5" />
                        </div>
                        <h3 className="text-xl font-semibold">Discord</h3>
                    </CardHeader>
                    <CardContent className="pt-2">
                        <p className="text-muted">Join our community on Discord.</p>
                    </CardContent>
                    <CardFooter>
                        <Button
                            variant="ghost"
            ...
            <div className="mt-20 mb-12">
                <h2 className="text-3xl md:text-4xl font-display font-semibold text-center mb-10 bg-gradient-to-r from-brand-pink via-brand-lavender to-brand-blue bg-clip-text text-transparent">
            ...
            [data-state="open"] > div[data-accordion-content] {
              animation: accordionDown 0.35s cubic-bezier(0.16, 1, 0.3, 1);
            }
            [data-state="closed"] > div[data-accordion-content] {
              animation: accordionUp 0.3s cubic-bezier(0.16, 1, 0.3, 1);
            }
